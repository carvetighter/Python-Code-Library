...
#
# SqlBuildColumnOrValueString
#		- is associated with the method SqlInsertIntoTable()
#		- builds the the column or value string for the insert statement
#
# SqlInsertIntoTable
...
def SqlGetTableColumns(m_sql_conn, m_table_name):
	...
	# variables
	string_schema, string_table_name = m_table_name.split('.')
	string_query_col_where = "TABLE_NAME = N'" + string_table_name + "' and TABLE_SCHEMA = '" + string_schema + "'"
	str_query_col = SqlGenSelectStatement(m_str_select = 'COLUMN_NAME', 
																		m_str_from = 'INFORMATION_SCHEMA.COLUMNS',
																	   m_str_where = string_query_col_where,
	...
	str_query_sys_table_obj_id = SqlGenSelectStatement(m_str_select = 'object_id',
																	...
																	m_str_where = "name = '" + string_table_name + "'")
...
def SqlBuildColumnOrValueString(m_list = [], m_string_vdc = '', bool_insert = False):
    ###############################################################################################
    ###############################################################################################
    #
...
def SqlInsertIntoTable(m_sql_conn, m_table_name, m_list_columns, m_list_values):
    ###############################################################################################
    ###############################################################################################
    #
...
def SqlUpdate(m_sql_conn, m_table_name, m_list_columns, m_list_values, m_list_where):
    ###############################################################################################
    ###############################################################################################
    #
